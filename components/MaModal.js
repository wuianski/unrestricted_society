    ...
    <>
      ...
      >
        ...
        >
          ...
          <div className={styles.Modal_content}>
            何謂愛、信仰、儀式、崇敬和上帝？我們能夠教育機器這些非常抽象、主觀的人類概念嗎？由於沒有明確定義和客觀視覺呈現，一個人工神經網路就被用來訓練我們對這類概念的主觀體驗，而雲端成為這些集體意識的保存者，影像存檔決定其模樣。
          </div>
          <div className={styles.Modal_content}>
            艾克滕運用程式語言自動下載的方式，從Flickr抓取數十萬張標記包含上述與其他字詞的圖片，來訓練這個神經網路，最終作品圖像由該網路深處的記憶碎片重新生成。聲音則來自YouTube上世界各地的禱文、祈禱和儀式，並以另一個人工神經網路訓練後產生。《深度冥想：60分鐘的萬物簡史》帶我們歷經宇宙的誕生、行星和地球的生成、演化、生態的形成、人類的誕生、文明、戰爭、藝術、宗教、科學⋯⋯。
          </div>
