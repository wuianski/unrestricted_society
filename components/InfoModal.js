      ...
      >
        ...
        >
          <div className={styles.info_textBlk}>
            ...
            <div className={styles.info_text_big}>臺灣當代文化實驗場 C-Lab</div>
          </div>
          <div className={styles.info_textBlk}>
            <div className={styles.info_text_small}>活動場地 Event Venues </div>
            <ul>
          ...
          <div className={styles.info_textBlk}>
            ...
            <ul>
              ...
              <div className={styles.info_text_medium}>Spatial Audio Field</div>
            </ul>
          </div>
          <div className={styles.info_textBlk}>
            <div className={styles.info_text_small}>
            ...
            <div className={styles.info_text_small}>ubike：建國濟南路口站</div>
            <div className={styles.info_text_small}>
