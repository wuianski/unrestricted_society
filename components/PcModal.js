      ...
      >
        ...
        >
          <div className={styles.Modal_content}>
            作品由四千名法國警察的臉組成，他們曾出現在2010至2020年間法國的抗爭運動中。奇里奧搜集了一千張含有警察的照片，並以人臉辨識軟體分析，再將所獲得的四千張警察臉孔，創建為一個線上資料庫，透過群眾的力量，逐一指認他們的身分。不僅如此，奇里奧還印出這些警察的大頭照，張貼在巴黎各處，讓他們暴露在公共場所。
          </div>
          <div className={styles.Modal_content}>
            藉由討論人臉辨識系統和人工智慧潛在的使用與錯用，《捕捉》質疑牽涉其中的不對等權力。而這類科技對隱私權規範的匱乏，最終將逆轉，用以對抗主張強力使用它們的當權者。這件作品的挑釁意味，在2020年展出時也引發法國內政部長與警察工會對其強行審查。
          </div>
          <div className={styles.Modal_content}>
